...
router.register('user',views.UserRegistration)
...
urlpatterns = [
    ...
    path('filterbycuisine', views.FilterbyCuisine.as_view()),
    path('filterbymealtype', views.FilterbyMealtype.as_view()),
    path('filterbyingredients', views.FilterbyIngredients.as_view()),
    path('createreview',views.CreateReview.as_view()),
    path('getreview/<int:pk>/',views.GetReview.as_view()),
]
